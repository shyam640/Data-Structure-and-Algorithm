...
void solve(lli n,lli m, lli val1, lli val2, lli val3){
   if((abs(val1-n)<=val3 and val1-1<=val3) or (abs(val2-m)<=val3 and val2-1<=val3) or (abs(val1-1) and val2-1<=val3))
      cout<<"-1"<<endl;
   else
      cout<<n+m-2<<endl;
}
...
int main() {
   ...
   cin>>t;
   while(t--){
      lli n,m,val1,val2,val3;
      cin>>n>>m>>val1>>val2>>val3;
      solve(n,m,val1,val2,val3);
